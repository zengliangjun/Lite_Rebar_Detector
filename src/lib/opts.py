...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', default='ctdetv2',
    ...
    self.parser.add_argument('--K', type=int, default=1024,
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    if hasattr(dataset, 'max_per_image'):
      opt.max_per_image = dataset.max_per_image
    ...
    elif opt.task == 'ctdet' or opt.task.startswith('ctdet'):
  ...
  def init(self, args=''):
    default_dataset_info = {
      ...
      'rebar': {'default_resolution': [1024, 1152], 'num_classes': 2, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'rebar', 'max_per_image': 1024},
    }
    class Struct:
